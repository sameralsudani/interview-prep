...
class User {
  ...
  login() {
    // define the method inside the class without function keyword
    console.log(this.email, "has logged in");
  }
  logout() {
    // define the method inside the class without function keyword
...
class Admin extends User {
  // with extends User, Admin will inherit/get all User properties and methods instead of copying them from User and paste them into Admin
  deleteUser(user) {
...
class House {
  constructor(color) {
    // constructor takes in all the parameters we want to put in the house when we create a new instance/object  of that house
...
class Square {
  ...
  get area() {
    // this is a getter, area ia just a normal method now
